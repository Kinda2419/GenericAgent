...
try:
    import frontends.chatapp_common as chatapp_common  # activate /continue command (monkey patches GeneraticAgent)
    from frontends.continue_cmd import handle_frontend_command, reset_conversation, list_sessions, extract_ui_messages
    from frontends.btw_cmd import handle_frontend_command as btw_handle_frontend
