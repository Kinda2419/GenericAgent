...
try:
    import frontends.chatapp_common as chatapp_common  # noqa: F401
    from frontends.chatapp_common import format_restore
    from frontends.btw_cmd import handle_frontend_command as btw_handle
    from frontends.review_cmd import handle as review_handle
    from frontends.continue_cmd import list_sessions as continue_list, extract_ui_messages as continue_extract
...
class GenericAgentTUI(App[None]):
    ...
    def _do_continue_restore(self, path: str) -> str:
        sess = self.current
        try:
            from frontends.continue_cmd import reset_conversation, restore
        except ImportError:
